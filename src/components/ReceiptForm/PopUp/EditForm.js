...
const EditForm = ({ content }) => {
    return (
        <section className="form">
            ...
            <form className="w-100 mt-2 d-flex flex-column align-items-center">
                ...
                <div className="multiple-input d-flex w-100">
                    ...
                    <input id="edit-mode-quantity" defaultValue={content.quality} type="number" placeholder="Quantity" />
                </div>
            </form>
        </section>
    )
